...
public class InstanceOfEx1 {
	public static void main(String[] args) {
		...
		Child3 c;
		/*
		 *  s 참조변수가 참조하는 객체를 Child3타입으로 형변환 가능하니?
		 */
		if(s instanceof Child3) {
			c = (Child3)s;	//ClassCastException 예외발생
		...
		if(s instanceof Super3) {
			...
			s.method(); //method는 최종 오버라이딩된 값 출력 => Child3 메서드 
		...
		if(s instanceof Object) {
			...
			Object o = s;
//			System.out.println(o.x);//오류. Object의 멤버가 아니다.
//			System.out.println(o.y);//오류. Object의 멤버가 아니다.
//			o.method();//오류. Object의 멤버가 아니다.
		}
