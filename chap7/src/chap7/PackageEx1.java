...
import chap7.test.*; //chap7.test 패키지에 속한 모든 클래스들은 패키지명 생락
...
public class PackageEx1 {	//chap7.PackageEx1 클래스 (본래의 이름 패키지명을 포함하고있음)
	public static void main(String[] args) {
		...
		Pack2 p2 = new Pack2(); //같은 패키지에 속한 클래스가 아니라서 오류!
		p2.method();
	}
}
