...
public class StackQueueEx1 {
	public static void main(String[] args) {
		...
		System.out.println(stack.peek());	//peek() : 조회 //K9
		System.out.println("스택의 요소갯수:"+stack.size());//4
		
		System.out.println(stack.pop()); // pop() : 꺼내오는것 
		System.out.println("스택의 요소갯수:"+stack.size()); //3
		...
		System.out.println("큐의 요소갯수:"+queue.size());//3
