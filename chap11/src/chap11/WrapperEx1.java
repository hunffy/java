...
public class WrapperEx1 {
	public static void main(String[] args) {
		...
		System.out.println("i1==i2 :"+(i1==i2));//같은 객체가 아니기때문에 값은 false
		System.out.println("i1.equals(i2) :"+(i1.equals(i2)));//객체의 내용이 같은지 여부! equals를 사용
		...
		//10진수를 16진수 출력하기
		System.out.println(Integer.toHexString(num));//num을 16진수로 표시해줘
