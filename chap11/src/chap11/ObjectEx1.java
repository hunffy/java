 ...
 * 3. 모든 클래스의 객체는 Object 클래스의 멤버를 호출할 수 있다.
 * 
 * equals 메서드 : 동일성 판단 메서드. 객체의 내용비교를 위한 메서드
 * 				 객체의 내용의 동일성 판단을 위해서는 equals 메서드로 호출해야함.
 */
class Equal {
	int value;
	Equal(int value) {
...
public class ObjectEx1 {
	public static void main(String[] args) {
		Equal e1 = new Equal(10); //e1과  e2 는 참조하는 객체가 다름!
		Equal e2 = new Equal(10); //참조하는 객체가 다름!
		if(e1 == e2)	//참이라면 e1객체와 e2객체가 동일한 경우
