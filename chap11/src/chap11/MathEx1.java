...
public class MathEx1 {
	...
	public static void main(String[] args) {
		//abs : 절대값
		System.out.println("Math.abs(5)="+Math.abs(5));			//절대값 5
		System.out.println("Math.abs(-5)="+Math.abs(-5));		//절대값 5 
		...
		System.out.println("Math.rint(-5.4)="+Math.rint(-5.4)); //-5
		System.out.println("Math.rint(-5.5)="+Math.rint(5.5)); //-5
		System.out.println("Math.rint(-5.5)="+Math.rint(-5.5)); //-5
		...
		//Math.toDegrees(Math.PI/2) : 도 <=라디안
		...
		//sqrt : 제곱근
		System.out.println("Math.sqrt(25)="+Math.sqrt(25));//루트25 ->5
		//pow : 제곱
