 ...
 */
class MyException extends RuntimeException{ //=> RuntimeException 를 상속받아서 RuntimeException 하위클래스가 되어 예외처리가능!
	int pos;
...
*/
		throw new MyException("예외 강제 발생",29); //예외처리를 생략가능 한 예외클래스로 생성
	}
}